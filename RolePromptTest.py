...
role_chain = (
        template |
        llm.with_structured_output(RolePromptResult.RoleResult)
)
print(f"角色分析-LangChain链Invoke数据填充")
role = role_chain.invoke({})
print(role)
result = RolePromptResult.RoleResult.model_validate(role)
